      ...
      {appointment ? (
        <View style={styles.container}>
          <View style={styles.headerInfo}>
            <TouchableOpacity style={styles.image} onPress={() => navigation.navigate('DoctorDetails', {id: appointment.doctor.id})}>
              <Avatar
                size={60}
                rounded
            ...
            <View style={styles.headerTextWrapper}>
              <TouchableOpacity onPress={() => navigation.navigate('DoctorDetails', {id: appointment.doctor.id})}>
